...
from cs336_basics.transformers.utils import cross_entropy_loss,AdamW, get_lr_cosine_schedule, gradient_clipping, get_batch
from cs336_basics.transformers.utils import save_checkpoint, load_checkpoint
def run_linear(
    d_in: int,
    d_out: int,
